...
function invokeSpell(input) {
    ...
    console.log(obj)
    hasil= "combination doesn't exist"
    for (var i = 0; i < spells.length; i++) {
        if (obj.q == spells[i].q && obj.w == spells[i].w && obj.e == spells[i].e) {
            hasil= spells[i].spellName
        }
    }
    return hasil
}
